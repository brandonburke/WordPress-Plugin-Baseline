...
if ( isset($_GET['wds_dts_option']) && $_GET['wds_dts_option'] )
{
...
function wds_dts_bar() {
    ...
    <li>
		...
		Debug Info<br />
		<hr />
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_show_template"); ?>"><?php display_option_value('dts_show_template');?> Template File</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_load_time"); ?>"><?php display_option_value('dts_load_time');?> Load Time</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_show_queries"); ?>"><?php display_option_value('dts_show_queries');?> Queries</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_phpinfo"); ?>"><?php display_option_value('dts_phpinfo');?> PHPinfo</a>
		</div>
	</li>
        <li>
    	<div id="holder">
		Krumo Debug<br />
		<hr />
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_wp_query"); ?>"><?php display_option_value('dts_wp_query');?> WP_Query and WP</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_includes"); ?>"><?php display_option_value('dts_includes');?> Includes</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_functions"); ?>"><?php display_option_value('dts_functions');?> Functions</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_classes"); ?>"><?php display_option_value('dts_classes');?> Classes</a>
		<a href="<?php echo add_query_arg ("wds_dts_option", "dts_http_headers"); ?>"><?php display_option_value('dts_http_headers');?> HTTP Headers</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_constants"); ?>"><?php display_option_value('dts_constants');?> Constants</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_cookies"); ?>"><?php display_option_value('dts_cookies');?> Cookies</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_server"); ?>"><?php display_option_value('dts_server');?> $_SERVER</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_env"); ?>"><?php display_option_value('dts_env');?> $_ENV</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_session"); ?>"><?php display_option_value('dts_session');?> $_SESSION</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_post"); ?>"><?php display_option_value('dts_post');?> $_POST</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_get"); ?>"><?php display_option_value('dts_get');?> $_GET</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_request"); ?>"><?php display_option_value('dts_request');?> $_REQUEST</a>
        <a href="<?php echo add_query_arg ("wds_dts_option", "dts_k_phpinfo"); ?>"><?php display_option_value('dts_k_phpinfo');?> PHPinfo</a>
		</div>
	</li>
	</ul>
	</div>
...
class ShowDevSuite {
	...
	function show_template() {
		...
		if ( current_user_can('edit_plugins') ) {
			...
			If ($options_arr["dts_make_comment"] == "on") {
			...
			If ($options_arr["dts_load_time"] == "on") {
			...
			If ($options_arr["dts_show_queries"] == "on" ) {
...
function display_option_value($option_name) {
