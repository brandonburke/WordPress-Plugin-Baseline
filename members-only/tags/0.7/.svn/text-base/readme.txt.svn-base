...
== Changes ==
*0.7*
1. **New Feature:** Added the option to make individual posts and pages *Members Only* with the ability to set the default protect for pages and posts.
2. Added the ability to set the Post of Page protection from with the Write or Edit page.
3. Added and icon to the Manage Posts and Manage Pages page to show whether the are protect or not.
4. Rewritten how Page and Post protection.
5. Improved settings page by hiding options that are not applicable.
